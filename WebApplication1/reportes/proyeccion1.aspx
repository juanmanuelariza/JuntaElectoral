<%@ Page Title="" Language="VB" MasterPageFile="~/reportes/MasterPageReportes.master" AutoEventWireup="false" CodeFile="proyeccion1.aspx.vb" Inherits="proyeccion1_aspx" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="Panel2" runat="server">
                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">PORCENTAJE DE MESAS ESCRUTADAS DE PROVINCIA</h3>
                        </div>
                        <div class="box-body">
                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">SENADORES PROVINCIA</h3>
                        </div>
                        <div class="box-body">
                ...
                <div class="col-md-4">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">DIPUTADOS PROVINCIA</h3>
                        </div>
                        <div class="box-body">
                ...
                <div class="col-md-12">
                    <div class="box box-danger">
                        <div class="box-header with-border">
                            <h3 class="box-title">MESAS FALTANTES DE PROVINCIA</h3>
                        </div>
                        <div class="box-body">
                            <table id="dtFaltantesProvincia" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th>Mesa</th>
                                        <th>Estrato</th>
                                ...
                                <%=tmp_TablaMesasFaltantesProvincia %>
                            </table>
                        </div>
                    </div>
                    <!-- /.box-body -->
            ...
            <asp:Panel ID="Panel1" runat="server">
                ...
                <div class="col-md-12">
                    <div class="box box-danger">
                        <div class="box-header with-border">
                            <h3 class="box-title">MESAS FALTANTES DE MUNICIPIOS</h3>
                        </div>
                        <div class="box-body">
                            <table id="dtFaltantesMunicipios" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        <th>Mesa</th>
                                        <th>Estrato</th>
                                ...
                                <%=tmp_TablaMesasFaltantesMunicipios %>
                            </table>
                        </div>
                    </div>
                    <!-- /.box-body -->
    ...
    <script type="text/javascript">
        ...
        function initScripts() {
            $(function () {
                $('#dtFaltantesMunicipios').DataTable({
                    "responsive": true,
                    "paging": true,
                    "lengthChange": true,
                    "searching": true,
                ...
                $('#dtFaltantesProvincia').DataTable({
                    "responsive": true,
                    "paging": true,
                    "lengthChange": true,
                    "searching": true,
